...
- (void)loadView
{
    ...
    _contentView.backgroundColor =  [UIColor colorWithRed:35.0/255.0 green:31.0/255.0 blue:32.0/255.0 alpha:1.0];
...
{
     //if([Global sharedInstance].isShowingLandscapeView)
...
{
    /*
    [self.frontViewController.view setFrame:CGRectMake(-200, 0,
