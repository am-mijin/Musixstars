...
@interface RegistrationViewController : BaseViewController<RequestDelegate,UITableViewDelegate,UITableViewDataSource, UITextFieldDelegate>
...
@property (nonatomic, strong) UITextField	*promocode;
