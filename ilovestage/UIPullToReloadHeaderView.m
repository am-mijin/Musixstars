...
//#define BORDER_COLOR [UIColor colorWithRed:153.0/255.0 green:153.0/255.0 blue:153.0/255.0 alpha:1.0]
#define BORDER_COLOR [UIColor clearColor]
//#define BACKGROUND_COLOR [UIColor colorWithRed:0.2 green:0.2 blue:0.2 alpha:1.0];
...
//		arrowImage.image = [UIImage imageNamed:@"Pull-To-Refresh.png"];
//		[self addSubview:arrowImage];
	
		activityView = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle: UIActivityIndicatorViewStyleGray];
        
        activityView.frame = CGRectMake((320-10)/2, frame.size.height - 38.0f, 20.0f, 20.0f);
        ...
        /*
        loadingView = [[UIImageView alloc] initWithFrame: CGRectMake((320-(42/2))/2,frame.size.height -48.0f, 42/2, 42/2)];
